...
def test_list_rooms(integration_client, authorized_user):
    integration_client.post("/rooms", json={"id": "Room 104"}, headers=authorized_user)
    integration_client.post("/rooms", json={"id": "Room 237"}, headers=authorized_user)
    response = integration_client.get("/rooms", headers=authorized_user)
...
def test_list_rooms_by_activity(integration_client, authorized_user):
    ...
    integration_client.post(
        "/rooms/{}/messages".format("Room 237"),
        json={"content": "Hola"},
